...
// include icon fonts and font families  
gulp.task('icons', function() {
	return gulp
		.src('_assets/css/1-tools/fonts/*')
		.pipe(gulp.dest('_site/assets/css/fonts'));
});
...
/*
 before production
 clean any extraneous files and folders from your assets dir
 by running "gulp clean"
 then rebuild with "gulp"
*/
